...
Cufon.replace('.header h1, .header-alt h1, .header-alt-sec h1, .header-alt h4, .header-alt-sec h4, .header-inner h1, .subtitle h3', { hover: true, textShadow: '1px 1px 0 #444444', fontFamily: 'Arial' });
Cufon.replace('.btn-small, .btn-medium, .btn-big, .btn-big-light, .form-button, .accordion h2, .text-replace, .big-home-button', { hover: true, textShadow: '1px 1px 0 #ffffff', fontFamily: 'Arial' });
Cufon.replace('.btn-orange-small, .btn-orange-medium, .btn-orange-big', { hover: true, textShadow: '1px 1px 0 #cb6a20', fontFamily: 'Arial' });
Cufon.replace('.btn-green-small, .btn-green-medium, .btn-green-big', { hover: true, textShadow: '1px 1px 0 #588b11', fontFamily: 'Arial' });
Cufon.replace('.big-footer h4', { textShadow: '1px 1px 0 #555555', fontFamily: 'Arial' });
